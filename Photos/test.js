...
if (firstMatch) {
firstMatch = false;
$imageList.append('<li><a class="firstMatch" href="' + images[image].image + '"><img src="' + images[image].thumbnail + '" alt="' + images[image].caption + '"></a></li>')
} else {
...
console.log($("#image-list li").length);
